...
CREATE TABLE `containing` (
  ...
  KEY `fk_containing_booth1_idx` (`booth_idbooth`),
  CONSTRAINT `fk_containing_booth1` FOREIGN KEY (`booth_idbooth`) REFERENCES `booth` (`idbooth`),
  CONSTRAINT `fk_containing_registation1` FOREIGN KEY (`registation_idregistation`) REFERENCES `registration` (`idregistation`)
